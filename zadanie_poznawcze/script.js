    ...
    function submitResponse() {
        ...
        if (responseForm) {
            ...
            if (currentVideoIndex === 0) {
                alert("Poprawną odpowiedzią było 'Figura jest trójkątem'. Jeśli zaznaczyłeś/aś poprawnie - gratulacje! Teraz czekają Cię 4 właściwe zadania. Każde zadanie zawiera po 12 figur i trwa po 1 minucie. Po odpowiedzi, NIE będzie już jednak feedbacku, która odpowiedź była poprawna. Powodzenia!.");
            }
